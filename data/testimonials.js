export const testimonials = [
  {
    quote: `Ethical behavior is the cornerstone of M-TECH. We have
built our company on a reputation of honesty and
fairness. We pride ourselves on doing the right thing at
the right time for the right reason. Through integrity, we
solidify the connection that we build between M-TECH
and our clients.`,
    author: "INTEGRITY",
  },
  {
    quote: `Being cost aware is crucial to our business. At M-TECH, we
focus not only on managing our own costs, but our clients’
costs as well. Our clients projects remaining financially
viable is just as important to us as our own profitability.
Our company cannot prevail without our clients’
continued success.`,
    author: "FISCAL RESPONSIBILITY",
  },
  {
    quote: `At M-TECH, we embedded the safety in our values, coming
from our believe that success can not be achieved without
safety.`,
    author: "SAFETY",
  },
];
